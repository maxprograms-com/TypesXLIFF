...
export type XliffExtensionValue = string & { readonly __xliffExtensionValue?: never };
export type XliffInlineSubType = "xlf:lb" | "xlf:pb" | "xlf:b" | "xlf:i" | "xlf:u" | "xlf:var" | XliffExtensionValue;
export type XliffAnnotationType = "generic" | "comment" | "term" | XliffExtensionValue;